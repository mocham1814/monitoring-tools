  ...
  export default {
    ...
    methods: {
        ...
        load_data : function(id) {
            let self = this;
            axios
            .get(`${this.$axios.defaults.baseURL}/master/rak_tools/get_rak_toolById/`+id)
            .then(response => (this.rak = response.data))
      ...
      validate () {
        ...
        if (this.$refs.form.validate()) {
            ...
            let self = this;
            axios
            .post(`${this.$axios.defaults.baseURL}/master/rak_tools/update_rak_tools`, qs.stringify(self.rak)
             ,{
                headers: {
                  Authorization:  auth
                }
